...
// Written with raw Node req/res (no framework helpers) for max runtime compatibility.
...
module.exports = async (req, res) => {
  try {
    // Health check that touches nothing external — used to diagnose runtime issues.
